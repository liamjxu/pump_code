...
for survey in surveys:
    ...
    get_personas_from_survey(info_df, survey, prompt_name='get_personas_from_questions', output_dir='sm_local/outputs/extraction', print_result=False)
...
def clean_summarized_personas(prompt_name, survey, level, summarizing_dir, output_dir, num_clusters, print_result):
    ...
    response = get_llm_response(prompt, prefill='[', max_tokens=4096, model_id='anthropic.claude-3-sonnet-20240229-v1:0')
    response = '[' + response

...
if [ "$1" -eq 34 ]; then
    ...
    export SIMILAR_USER_MAPPING_FILENAME="opinions_qa/similar_users/${SURVEY_NAME}/date0905_personas_full_personadb_queryponly_trainAll_top150_skew3_withname.json"
elif [ "$1" -eq 82 ]; then
    ...
    # export SIMILAR_USER_MAPPING_FILENAME="opinions_qa/similar_users/${SURVEY_NAME}/date0905_personas_full_personadb_querydp_trainAll_top100_skew15_withname.json"
else
...
python -m src.predict \
    ...
    --log_name ${SURVEY_NAME}/date${DATE}_v17_personadb_surveys_bdemo_mostcommon_${SURVEY_NAME}_${PREDICT_MODEL}pred_prompt3_history_demo_persona_rag_run${i}.json \

...
#     --log_name date0729_vanilla_persona_v3high_American_Trends_Panel_W26.json \
...
#     --exp_setting vanilla_persona \
#     --survey_name American_Trends_Panel_W26 \
#     --log_name date0802_vanilla_persona_v6all_namevalue_selected_sonnetinfer_American_Trends_Panel_W26.json \
...
python -m experiment.predict \
    ...
    --exp_setting vanilla_persona \
    --survey_name American_Trends_Panel_W26 \
    --log_name date0802_vanilla_persona_v6low_namevalue_selected_sonnetinfer_American_Trends_Panel_W26.json \
    --persona_filename opinions_qa/persona/date0729_midterm_personas_full_sonnet.json
...
python -m experiment.predict \
    ...
    --log_name date0804_v7_vanilla_persona_alllevels_allpersonas_namedescvalue_sonnetinfer_American_Trends_Panel_W26.json

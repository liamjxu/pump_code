...
#     --exp_setting vanilla_no_history_persona \
#     --survey_name American_Trends_Panel_W26 \
#     --log_name date0802_vanilla_no_history_persona_v6low_selected_sonnetinfer_American_Trends_Panel_W26.json \
#     --persona_filename opinions_qa/persona/date0729_midterm_personas_full_sonnet.json
...
#     --exp_setting vanilla_no_history_persona \
#     --survey_name American_Trends_Panel_W26 \
#     --log_name date0802_vanilla_no_history_persona_v6all_selected_sonnetinfer_American_Trends_Panel_W26.json \
#     --persona_filename opinions_qa/persona/date0729_midterm_personas_full_sonnet.json
...
#     --exp_setting vanilla_no_history_persona \
#     --survey_name American_Trends_Panel_W26 \
#     --log_name date0802_vanilla_no_history_persona_v6all_namevalue_selected_sonnetinfer_American_Trends_Panel_W26.json \
#     --persona_filename opinions_qa/persona/date0729_midterm_personas_full_sonnet.json
...
#     --exp_setting vanilla_no_history_persona \
#     --survey_name American_Trends_Panel_W26 \
#     --log_name date0802_vanilla_no_history_persona_v6all_value_selected_sonnetinfer_American_Trends_Panel_W26.json \
#     --persona_filename opinions_qa/persona/date0729_midterm_personas_full_sonnet.json
...
#     --exp_setting vanilla_no_history_persona \
#     --survey_name American_Trends_Panel_W26 \
#     --log_name date0802_vanilla_no_history_persona_v6low_namevalue_selected_sonnetinfer_American_Trends_Panel_W26.json \
#     --persona_filename opinions_qa/persona/date0729_midterm_personas_full_sonnet.json
...
#     --log_name date0802_v7_vanilla_no_history_persona_all_namedescvalue_selected_sonnetinfer_American_Trends_Panel_W26.json
...
python -m experiment.predict \
    ...
    --persona_level low mid high \
    --persona_repr namedescvalue \
    --log_name date0804_v7_vanilla_no_history_persona_alllevels_allpersonas_namedescvalue_sonnetinfer_American_Trends_Panel_W26.json

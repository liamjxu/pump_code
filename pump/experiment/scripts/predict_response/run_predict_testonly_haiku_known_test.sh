...
export TOP_K=20
export SKEW=10
export SIMILAR_USER_MAPPING_FILENAME=opinions_qa/similar_users/${SURVEY_NAME}/date0831_personas_full_haiku_known_test_train${TRAIN_SIZE}_top${TOP_K}_skew${SKEW}_withname.json
...
python -m src.predict \
    ...
    --log_name ${SURVEY_NAME}/date${DATE}_v16_known_test_rag_train${TRAIN_SIZE}_top${TOP_K}_skew${SKEW}_withname_${SURVEY_NAME}_${PREDICT_MODEL}pred_prompt3_history_demo_persona_run${i}.json \

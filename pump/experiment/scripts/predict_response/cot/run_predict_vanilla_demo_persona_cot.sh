...
python -m experiment.predict \
    ...
    --exp_setting vanilla_demo_persona_cot \
    ...
    --log_name date0804_v8_vanilla_demo_persona_cot_alllevels_allpersonas_namedescvalue_sonnetinfer_American_Trends_Panel_W26.json
